    ...
    */
    public void testWeatherTable() {
        ...
        Cursor weatherCursor = db.query(
                ...
                null,   //Leaving "Column" null just returns all columns.
    ...
    public long insertLocation() {
        ...
        Cursor cursor = db.query(
                ...
                null,   // Columns to group by
                null,   // columns to filer by row groups
                null    // sort order
        );

        // Move the cursor to a valid database row
        assertTrue("Error: No records returned from lactation query",cursor.moveToFirst());
